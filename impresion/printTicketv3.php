...
try {
    ...
    $printer -> text("   ----------------------------------\n");
    $printer -> text("Puede pagar sus intereses a las Cuentas Bancarias:\n");
    $printer -> text("De la Nación (Ahorros S/. G. Manrique): \n04388436250\n");
    $printer -> text("De Crédito (Ahorros S/. Y. Huaycuch): \n35537720329079\n");
