...
try {
    ...
    $printer -> text("   ----------------------------------\n");
    $printer -> text("Puede pagar sus intereses a las cuentas:\n");
    $printer -> text("Banco de la Nación (Ahorros Soles - G. Manrique): 04388436250\n");
    $printer -> text("Banco de Credito (Ahorros Soles - Y. Huaycuch): 35537720329079\n");
    $printer -> text("Otras cuentas u otros campos al Whatsapp 943 798696\n");
    $printer -> text("   ----------------------------------\n");
